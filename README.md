...
面向中文论文写作的 Codex Skill。你可以先导入已有文献；如果手里还没有文献，它也可以先帮你生成 CNKI、万方、维普、学校图书馆和公开来源的检索策略，并补充待核验候选文献。随后再生成文献矩阵、研究脉络、研究空白、创新点建议和更自然的中文综述段落。
...
这个 skill 的工作方式相反：优先导入你已有的 CNKI、万方、维普、学校图书馆、期刊官网、Zotero、BibTeX、RIS 或 PDF 文献资料；如果你还没有文献，它会先帮你拆关键词、生成数据库检索式、推荐查找路径，并从公开来源补充候选文献，等你核验后再进行整理、分析和写作。
...
| 功能 | 输出 |
| --- | --- |
| 从零查找文献 | 在用户没有文献时，生成 CNKI、万方、维普、学校图书馆、期刊官网和公开来源的检索策略 |
...
如果我还没有文献，请先帮我生成 CNKI、万方、维普、学校图书馆、期刊官网和公开来源的检索策略，并列出待核验候选文献。
...
2. 如果你还没有文献，先让 skill 根据论文主题生成 CNKI、万方、维普、学校图书馆、期刊官网和公开来源的检索策略。
3. 优先导入 Zotero、BibTeX、RIS、CNKI、万方、维普、学校图书馆或期刊官网导出的资料。
4. 先生成文献矩阵，不急着写正文。
5. 检查作者、题名、期刊、年份、摘要、关键词、DOI/链接是否完整。
6. 文献不够时，再用公开来源或已配置接口补充候选文献，候选文献必须核验后再进入正式综述。
...
| 场景 | 示例 |
| --- | --- |
| 没有文献或文献不足时生成检索策略 | [查看示例](./examples/02-topic-to-search-strategy.md) |
...
```text
我的论文主题是“乡村振兴背景下基层数字治理”。我现在还没有整理好的文献，请先帮我生成 CNKI、万方、维普、学校图书馆和公开来源的检索策略；如果能从公开来源找到候选文献，请先列为“待核验候选文献”，不要直接写进正式综述。
```
...
即使你暂时没有文献，也可以先输入论文主题、研究方向、关键词、学科和论文类型，让 skill 帮你生成查找路径。
